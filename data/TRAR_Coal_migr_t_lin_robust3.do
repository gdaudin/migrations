...
outreg2 using TRAR_Coal_migr_t_lin_robust3,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(1)   label excel
drop f
...
outreg2  using TRAR_Coal_migr_t_lin_robust3, br label excel
...
generate f=Fden(e(df_m),e(df_r),e(F))
outreg2 using TRAR_Coal_migr_t_lin_robust3,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(3)   label excel
drop f
