...
******************************
replace f_obs=log(f_obs_min50y)
******************************
label var f_obs "log(Fertility) (t-50)"
******************************
...
outreg2 using TRAR_Coal_fobsmin50y_migr_t_lin,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(1)   label excel
drop f
...
outreg2  using TRAR_Coal_fobsmin50y_migr_t_lin, br label excel


xi: xtreg  f_obs norme_dest norme_ori    norm_dest_x_lnp_pop                norm_ori_x_lnp_pop lnp_pop_emigr lnp_pop_immigr i.annee_obs if cylin==1    , fe robust  cluster(dptresid)
estimates store c
****foreach i in f_dest_emigr_TRAR_Coal_fobsmin50y_p  f_d_lnp_pop_emigr_TRAR_Coal_fobsmin50y_p lnp_pop_emigr_TRAR_Coal_fobsmin50y_p l {
foreach i in norme_dest    norm_dest_x_lnp_pop  {
            quietly summarize `i' if e(sample) 
...
***nlcom _b[lnp_pop_emigr_TRAR_Coal_fobsmin50y_p]+ _b[xx]*`meanf_dest_emigr_TRAR_Coal_fobsmin50y_p '+ _b[l1_fert_obs_lnp_pop_emigr_TRAR_Coal_fobsmin50y_p]*`meanlag1_fert_obs'+ _b[_p], post
***nlcom _b[lnp_pop_emigr_TRAR_Coal_fobsmin50y_p]+ _b[xx]*`meanf_dest_emigr_TRAR_Coal_fobsmin50y_p '+ _b[l1_fert_obs_lnp_pop_emigr_TRAR_Coal_fobsmin50y_p]*`meanlag1_fert_obs', post
...
xi: xtreg  f_obs norme_dest    norme_ori  norm_dest_x_lnp_pop              norm_ori_x_lnp_pop lnp_pop_emigr lnp_pop_immigr i.annee_obs if cylin==1    , fe robust  cluster(dptresid)
estimates store c
****foreach i in f_dest_emigr_TRAR_Coal_fobsmin50y_p  f_d_lnp_pop_emigr_TRAR_Coal_fobsmin50y_p lnp_pop_emigr_TRAR_Coal_fobsmin50y_p   {
...
xi: xtreg  f_obs norme_dest   norme_ori norm_dest_x_lnp_pop   norm_ori_x_lnp_pop lnp_pop_emigr lnp_pop_immigr revuedesdeuxmondes_newsstand rd2M_fecParis    lifeexpectancy15 mortalityratio_1 urban   lnp_industrie  lnp_professionsliberales  lnwomen_education_10yb lnmen_education_10yb lnpropfillescongreganistes lnpropgarconscongreganistes revuedesdeuxmondes_newsstand rd2M_fecParis   i.annee_obs if cylin==1  , fe robust  cluster(dptresid)
generate f=Fden(e(df_m),e(df_r),e(F))
outreg2 using TRAR_Coal_fobsmin50y_migr_t_lin,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(3)   label excel
drop f
