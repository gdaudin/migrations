...
graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_nofm_mig2dest0.gph", replace
*graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0 0.4)) ylabel(0 (0.05) 0.4)
*graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_nofm_mig2bdest0.gph", replace
...
graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0.02 0.04)) ylabel(0.02 (0.005) 0.04)
graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_onlyf_mig2dest0.gph", replace
*graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0 0.4)) ylabel(0 (0.05) 0.4)
*graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_onlyf_mig2bdest0.gph", replace
...
*graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(black)) (line mef_obs_predict annee_obs, lpattern(dash_dot) lcolor(black)) (line mef_obs_counterfactual_dest0 annee_obs, lwidth(thick) lpattern(solid) lcolor(black)), legend(label(1 Actual fertility)) legend(label(2 Predicted fertility)) legend(label(3 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0.2 0.32)) ylabel(0.2 (0.05) 0.3)
graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0.02 0.04)) ylabel(0.02 (0.005) 0.04)
graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_onlym_mig2dest0.gph", replace
*graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0 0.4)) ylabel(0 (0.05) 0.4)
*graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_onlym_mig2bdest0.gph", replace
...
*graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(black)) (line mef_obs_predict annee_obs, lpattern(dash_dot) lcolor(black)) (line mef_obs_counterfactual_dest0 annee_obs, lwidth(thick) lpattern(solid) lcolor(black)), legend(label(1 Actual fertility)) legend(label(2 Predicted fertility)) legend(label(3 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0.2 0.32)) ylabel(0.2 (0.05) 0.3)
graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0.02 0.04)) ylabel(0.02 (0.005) 0.04)
graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_exclParis_mig2dest0.gph", replace
*graph twoway (line mef_obs annee_obs, lpattern(solid)  lcolor(red))  (line mef_obs_counterfactual_dest0 annee_obs,  lpattern(solid) lcolor(blue))  (line f_obs_counterfactual_dest0lowsd annee_obs, lpattern( shortdash)  lcolor(black)) (line f_obs_counterfactual_dest0highsd annee_obs, lpattern(shortdash)  lcolor(black)), legend(label(1 Actual fertility))  legend(label(2 Counterfactual fertility)) xscale(range(1871 1911)) xlabel(1871(10)1911) yscale(range(0 0.4)) ylabel(0 (0.05) 0.4)
*graph save Graph "C:\Users\USER\Documents\Migrations\data\predict\Graph_TFR_exclParis_mig2bdest0.gph", replace
