...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_t_o_P_migr_lin_var_oldpredict1861.log", replace
use "C:\Users\USER\Documents\Migrations\data\predict\TRAR__TFR_t_o_P_migr_lin_var_oldpredict1861.dta",clear
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_t_p_P_migr_lin_var_oldpredict1861.log", replace
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_f_o_P_migr_lin_var_oldpredict1861.log", replace
use "C:\Users\USER\Documents\Migrations\data\predict\TRAR__TFR_f_o_P_migr_lin_var_oldpredict1861.dta",clear
do "C:\Users\USER\Documents\Migrations\data\predict\\pearson.do"
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1861 & cylin==1 
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1871 & cylin==1 
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1881 & cylin==1 
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_f_p_P_migr_lin_var_oldpredict1861.log", replace
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_m_o_P_migr_lin_var_oldpredict1861.log", replace
use "C:\Users\USER\Documents\Migrations\data\predict\TRAR__TFR_m_o_P_migr_lin_var_oldpredict1861.dta",clear
do "C:\Users\USER\Documents\Migrations\data\predict\\pearson.do"
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1861 & cylin==1 
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1871 & cylin==1 
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1881 & cylin==1 
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_m_p_P_migr_lin_var_oldpredict1861.log", replace
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_t_o_SP_migr_lin_var_oldpredict1861.log", replace
use "C:\Users\USER\Documents\Migrations\data\predict\TRAR__TFR_t_o_SP_migr_lin_var_oldpredict1861.dta",clear
do "C:\Users\USER\Documents\Migrations\data\predict\\pearson.do"
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1861 & cylin==1 
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1871 & cylin==1 
sum ef_obs ef_obs_predict ef_obs_counterfactual_ori0 ef_obs_counterfactual_dest0 ef_obs_counterfactual_deor0 pearsonstat if annee_obs==1881 & cylin==1 
...
log using "C:\Users\USER\Documents\Migrations\data\predict\sum_TRAR__TFR_t_p_SP_migr_lin_var_oldpredict1861.log", replace
