...
outreg2 using TRAR_TFR_migr_m_lin,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(1)   label excel
drop f
...
outreg2  using TRAR_TFR_migr_m_lin, br label excel
...
generate f=Fden(e(df_m),e(df_r),e(F))
outreg2 using TRAR_TFR_migr_m_lin,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(3)   label excel
drop f
