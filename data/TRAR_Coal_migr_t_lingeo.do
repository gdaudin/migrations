...
outreg2 using TRAR_Coal_migr_t_lingeo,br addstat(Within R2, e(r2_w), R2, e(r2), Log-pseudolikelihood, e(ll), Mean of fixed effects, e(a_avg)) adec(1)   label excel
...
*outreg2 using TRAR_Coal_migr_t_lin,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(1)   label excel
*drop f
...
*generate f=Fden(e(df_m),e(df_r),e(F))
*outreg2 using TRAR_Coal_migr_t_lin,br addstat(Within R2, e(r2), Adjusted R2, e(r2_a), F-stat, e(F), Prob>F-stat, f) adec(3)   label excel
*drop f
